...
class RayPPOTrainer(object):
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            print("-------------yes this is ground truth----------------")
            print(test_batch[0].non_tensor_batch['reward_model']['ground_truth'])
            # breakpoint()
            # test_gen_batch.non_tensor_batch['labels'] = np.array([data.non_tensor_batch['reward_model']['ground_truth'] for data in test_batch])
    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                print("gen_batch here:", gen_batch)
